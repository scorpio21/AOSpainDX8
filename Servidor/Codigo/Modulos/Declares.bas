...
Type UserFlags
    ...
    DuracionEfecto As Long
    TargetNpc As Integer ' Npc seï¿½alado por el usuario
    TargetNpcTipo As Integer ' Tipo del npc seï¿½alado
    NpcInv As Integer
    
    Ban As Byte
    AdministrativeBan As Byte
    
    TargetUser As Integer ' Usuario seï¿½alado
