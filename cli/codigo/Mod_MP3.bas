...
Public Const SND_WAV_CLICK = "click.mp3"
Public Const SND_WAV_OVER = "click2.mp3"
Public Const SND_WAV_DICE = "cupdice.mp3"
Public Const SND_WAV_PASOS1 = "23.mp3"
Public Const SND_WAV_PASOS2 = "24.mp3"
